...
Earlier UI phase reports are internal project history and are not included in this
shareable repository. This document describes the current workbench contract.
