...
|------|-------------|---------|-----------|--------------|-------------|----------------|-------------|----------------|
| `real-lab-172.28.0.12-juiceshop-zap.json` | 2026-09-19 | ZAP 2.16.1 daemon (loopback API) + spider + passive scan against `http://172.28.0.12:3000` (OWASP Juice Shop 20.2.0); report generated by ZAP core.jsonreport (zap-baseline -J format) | Juice Shop on 172.28.0.12 (owner's loopback lab) | repository owner's agent, at the owner's explicit instruction | canary log supplied and empty | | | | | | | | | |
